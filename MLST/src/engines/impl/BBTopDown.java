 ...
 * @param <E>
 */
public class BBTopDown<N extends Node, E extends Edge<N>> extends Algorithm<N, E> {

  public BBTopDown(LabeledUndirectedGraph<N, E> graph) throws NotConnectedGraphException {
    super(graph);
  }
