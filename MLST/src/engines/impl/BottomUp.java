 ...
 * @param <E>
 */
public class BottomUp<N extends Node, E extends Edge<N>> extends Algorithm<N, E> {

  public BottomUp(LabeledUndirectedGraph<N, E> graph) throws NotConnectedGraphException {
    super(graph);
