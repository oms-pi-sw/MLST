 ...
 * @param <E>
 */
public class BBBottomUpT<N extends Node, E extends Edge<N>> extends BBBottomUp<N, E> {

  private final Object lock = new Object();

  public BBBottomUpT(LabeledUndirectedGraph<N, E> graph) throws NotConnectedGraphException {
    super(graph);
  }
